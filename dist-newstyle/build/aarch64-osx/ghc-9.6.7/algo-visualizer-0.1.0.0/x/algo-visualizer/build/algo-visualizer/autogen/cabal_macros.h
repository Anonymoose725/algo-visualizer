...
/* package algo-visualizer-0.1.0.0 */
#ifndef VERSION_algo_visualizer
#define VERSION_algo_visualizer "0.1.0.0"
#endif /* VERSION_algo_visualizer */
#ifndef MIN_VERSION_algo_visualizer
#define MIN_VERSION_algo_visualizer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_algo_visualizer */
...
#define CURRENT_COMPONENT_ID "algo-visualizer-0.1.0.0-inplace-algo-visualizer"
